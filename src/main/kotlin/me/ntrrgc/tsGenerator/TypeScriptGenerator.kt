...
class TypeScriptGenerator(
    ...
    private fun generateInterface(klass: KClass<*>): String {
        ...
        val extendsString = if (superclasses.isNotEmpty()) {
            " extends " + klass.supertypes
                    .map { arg -> formatKType(arg).formatWithoutParenthesis() }
                    .joinToString(", ")
        } else ""

        val templateParameters = genericParameters(klass)
    ...
    private fun genericParameters(klass: KClass<*>): String {
